...
router.get('/:workspaceId', protect, requireWorkspace, requireWorkspacePermission('workspace:read'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.post('/:workspaceId/preview', protect, requireWorkspace, requireWorkspacePermission('workspace:read'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.put('/:workspaceId', protect, requireWorkspace, requireWorkspacePermission('workspace:manage_subscription'), async (req: AuthenticatedRequest, res: Response) => {
  try {
...
router.delete('/:workspaceId', protect, requireWorkspace, requireWorkspacePermission('workspace:manage_subscription'), async (req: AuthenticatedRequest, res: Response) => {
  try {
    const { default: Subscription } = await import('../models/Subscription');
