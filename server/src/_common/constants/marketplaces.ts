import { Marketplace, OpportunityCategory, MarketplaceCategory } from '../types/marketplace';

const SUPPORTED_MARKETPLACES: Marketplace[] = [
  {
    id: 'shopify',
    name: 'Shopify',
