...
export function Subscription() {
  const [subscriptionData, setSubscriptionData] =
    useState<WorkspaceSubscriptionData | null>(null);
    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Your hired AI contributors and their capabilities
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!subscriptionData || !subscriptionData.hasActiveSubscription ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold mb-2">
                No Contributors Hired
              </h3>
              <p className="text-muted-foreground mb-6">
                You need to hire AI contributors to automate your marketplace
                operations.
              </p>
            ...
            <div className="space-y-6">
              ...
              <div
                className={`flex items-center gap-4 p-4 rounded-lg ${getContributorTypeColor(
                  subscriptionData.currentPlan.contributorType
                )}`}
              >
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="text-xl font-semibold">
                        1x {subscriptionData.currentPlan.displayName}
                      </h3>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <div className="text-2xl font-bold">
                      ${formatPrice(subscriptionData.currentPlan.monthlyPrice)}
                      /month
                    </div>
                  ...
                  <div>
                    <div className="text-2xl font-bold">
                      {subscriptionData.currentPlan.actionsPerContributor === -1
                        ? "Unlimited"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <div className="font-medium">
                    {subscriptionData.limits.maxStores}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Max Stores
                  </div>
                ...
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <div className="font-medium">
                    {subscriptionData.limits.maxProducts.toLocaleString()}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    Max Products
                  </div>
                ...
                <div className="text-center p-4 border rounded-lg">
                  ...
                  <div className="font-medium">
                    {subscriptionData.limits.apiCallsPerMonth.toLocaleString()}
                  </div>
                  <div className="text-sm text-muted-foreground">
                    API Calls/Month
                  </div>
      ...
      {subscriptionData && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How your contributors are performing this month
            </CardDescription>
          </CardHeader>
          <CardContent>
            {usageData && (
              <div className="space-y-6">
                ...
                <div>
                  ...
                  {subscriptionData.limits.apiCallsPerMonth !== -1 && (
                    <Progress
                      value={getUsagePercentage(
                        ...
                        subscriptionData.limits.apiCallsPerMonth
                      )}
                      className="h-2"
                    />
                  )}
                  <div className="text-xs text-muted-foreground mt-1">
                    ...
                    {usageData.currentPeriod.apiCalls.toLocaleString()} actions
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                    <div className="text-center p-3 bg-background rounded border">
                      ...
                      <div className="font-medium text-sm">
                        {subscriptionData.currentPlan.displayName}
                      </div>
                      ...
                      <div className="text-xs text-green-600 mt-1">
                        {subscriptionData.currentPlan.actionsPerContributor ===
                        -1
                          ? "Unlimited capacity"
                          : `${(
                              (usageData.currentPeriod.apiCalls /
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {usageData.currentPeriod.totalProducts.toLocaleString()} /{" "}
                      {subscriptionData.limits.maxProducts.toLocaleString()}
                    </span>
                  </div>
                  <Progress
                    value={getUsagePercentage(
                      usageData.currentPeriod.totalProducts,
                      subscriptionData.limits.maxProducts
                    )}
                    className="h-2"
                  />
                </div>
